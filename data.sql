...
(10001,NULL,NULL,NULL,'2019-12-20','2019-12-20','2019-12-20','2019-12-24',NULL,NULL),
(10002,NULL,NULL,NULL,'2019-11-30','2019-11-30','2019-11-30','2019-12-2',NULL,NULL),
(10003,NULL,NULL,NULL,'2019-6-12','2019-6-12','2019-6-12','2019-6-14',2019-6-16,NULL),
(10004,NULL,NULL,NULL,'2019-12-20','2019-12-20','2019-12-20','2019-12-24',NULL,NULL),
(10005,NULL,NULL,NULL,'2019-7-14','2019-7-14','2019-7-14','2019-7-14',NULL,2019-7-24);
...
UPDATE Order SET customer_id = 151 WHERE order_id = 10001;
UPDATE Order SET customer_id = 154 WHERE order_id = 10002;
UPDATE Order SET customer_id = 153 WHERE order_id = 10003;
UPDATE Order SET customer_id = 155 WHERE order_id = 10004;
UPDATE Order SET customer_id = 152 WHERE order_id = 10005;
...
UPDATE Order SET payment_id = 100001 WHERE order_id = 10001;
UPDATE Order SET payment_id = 100004 WHERE order_id = 10002;
UPDATE Order SET payment_id = 100003 WHERE order_id = 10003;
UPDATE Order SET payment_id = 100005 WHERE order_id = 10004;
UPDATE Order SET payment_id = 100002 WHERE order_id = 10005;
...
UPDATE Order SET cart_id = 1054 WHERE order_id = 10001;
UPDATE Order SET cart_id = 1055 WHERE order_id = 10002;
UPDATE Order SET cart_id = 1053 WHERE order_id = 10003;
UPDATE Order SET cart_id = 1052 WHERE order_id = 10004;
UPDATE Order SET cart_id = 1051 WHERE order_id = 10005;
